...
# circle  (img,   calculating center    of      image, radius, colour, thickness)
...
#           (img, top_left_cor, bot_rit_cor, color, thickness)
...
cv2.putText(image,'ROS, OpenCV',(10,500), font, 3,(255,0,255),2,cv2.LINE_AA) # cv2.Line_AA mean smooth text
cv2.putText(image,'OpenCV',(8,400), font, 3,(255,255,255),2)
